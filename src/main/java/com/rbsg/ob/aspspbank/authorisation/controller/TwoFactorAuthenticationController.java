package com.rbsg.ob.aspspbank.authorisation.controller;


import com.rbsg.ob.aspspbank.authorisation.configuration.CustomOAuth2RequestFactory;
import com.rbsg.ob.aspspbank.authorisation.configuration.TwoFactorAuthenticationFilter;
...
public class TwoFactorAuthenticationController {
    ...
    public String auth(HttpServletRequest request, HttpSession session) {
        ...
        if(null!=payment) {
            ...
            if (new BigDecimal("30").compareTo(amount) == 0 || new BigDecimal("30").compareTo(amount) == 1 || payment.isTrustedBeneficiery()) {
